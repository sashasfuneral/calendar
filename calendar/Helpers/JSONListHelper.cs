...
namespace calendar.Helpers
{
    ...
    {
        public static string GetEventListJSONString(List<calendar.Models.Event> events)
        {
        ...
        public static string GetResourceListJSONString(List<calendar.Models.Location> locations)
        {
